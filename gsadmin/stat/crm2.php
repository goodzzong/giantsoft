...
//-->
	...
	<?
	if($_GET[date]==1) {
		$result=$db->result("select left(trade_money_ok, 4), count(idx), sum(trade_total_price), count(if(userid!='', userid, null)) from cs_trade where (trade_stat=2 or trade_stat=3 or trade_stat=4) group by left(trade_money_ok, 4)");	
	...
	<?
		...
		$result=$db->result("select substring(trade_money_ok, 6, 2), count(idx), sum(trade_total_price), count(if(userid!='', userid, null)) from cs_trade where (trade_stat=2 or trade_stat=3 or trade_stat=4) group by substring(trade_money_ok, 6, 2)");
	...
	<?
		...
		$result=$db->result("select substring(trade_money_ok, 9, 2), count(idx), sum(trade_total_price), count(if(userid!='', userid, null)) from cs_trade where (trade_stat=2 or trade_stat=3 or trade_stat=4) group by substring(trade_money_ok, 9, 2)");
	...
	<?
		...
		$result=$db->result("select WEEKDAY(left(trade_money_ok, 10)), count(idx), sum(trade_total_price), count(if(userid!='', userid, null)) from cs_trade where (trade_stat=2 or trade_stat=3 or trade_stat=4) group by WEEKDAY(left(trade_money_ok, 10))");
	...
	<?
		...
		$result=$db->result("select substring(trade_money_ok, 6, 2), count(idx), sum(trade_total_price), count(if(userid!='', userid, null)) from cs_trade where left(trade_money_ok, 4)='$_GET[year]' and (trade_stat=2 or trade_stat=3 or trade_stat=4) group by substring(trade_money_ok, 6, 2)");
	...
	<?
		...
		$result=$db->result("select substring(trade_money_ok, 9, 2), count(idx), sum(trade_total_price), count(if(userid!='', userid, null)) from cs_trade where left(trade_money_ok, 4)='$_GET[year]' and substring(trade_money_ok, 6, 2)=$_GET[mon] and (trade_stat=2 or trade_stat=3 or trade_stat=4) group by substring(trade_money_ok, 9, 2)");
