...
<body>
	...
	<tr>
		...
		<th>아이디</th>
		<td class="text-center"><? if($trade_stat->userid) {?><?=$trade_stat->userid;?><?} else {?>비회원<?}?></td>
	</tr>
	</tbody>
	</table>
	...
	<tr>
		<th>이메일</th>
		<td colspan="3"><?=$trade_stat->email;?></td>
	</tr>
	<tr>
		<th>주 소</th>
		<td colspan="3">(<?=$trade_stat->zip_new;?>)<br>
			<?=$trade_stat->add1;?><br>
			<?=$trade_stat->add2;?>
		</td>
	</tr>
	<tr>
		<th>배송메세지</th>
		<td colspan="3"><?echo nl2br($trade_stat->content);?></td>
	</tr>
	</tbody>
	</table>
