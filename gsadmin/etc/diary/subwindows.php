...
<?
	...
	$sql = $sql."and calendar_date = '$SelectedDay'";
	...
	$calendar_date = trim($SelectedDay);
	$write_date = date("Y-m-d H:i:s");

	if ($save == "ok") {

			$sql = "insert into diary set
						content='$content',
...
<div class="col-md-6 col-md-offset-3" ><!-- 테이블 위치 -->
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				<th>내용</th>
				<td><textarea name="memofield" class="form-control" rows="5" ></textarea></td>
			</tr>
			<!-- <tr>
				<th>최종 기록</th>
	...
	<table class="table">
		<tr>
			<td class="text-center"><a href="javascript:send(this.form);" class="btn btn-primary btn-sm">저장하기</button></td>
		</tr>
	</table>
