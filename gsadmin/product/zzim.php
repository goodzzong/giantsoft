...
<div class="text-right">
	...
	<?if($totalList){?>
	<a href="javascript:;" class="btn btn-danger btn-xs ajax-checkbox" data-dbname="<?=$table?>" data-name="delete" data-val=""><i class="glyphicon glyphicon-trash"></i>&nbsp;삭제</a>
	<?}?>
</div><p>
...
<tr>
	...
	<td class="text-center"><img src="<?=$site_url?>/data/goodsImages/<?=$goods_row->images1?>" alt="" class="img-responsive img50"></td>
