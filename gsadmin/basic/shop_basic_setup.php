...
//-->
	...
	<h5 class="page-header"><span class="glyphicon glyphicon-play" aria-hidden="true"></span> 쇼핑몰 기본정보</h5>
	...
	<h5 class="page-header"><span class="glyphicon glyphicon-play" aria-hidden="true"></span> 결제 정보</h5>
	<table class="table table-bordered">
	<colgroup>
	<col width="15%">
	<col width="35%">
	...
	<h5 class="page-header"><span class="glyphicon glyphicon-play" aria-hidden="true"></span> 배송비</h5>
	<table class="table table-bordered">
	<colgroup>
	<col width="15%">
	<col width="15%">
	...
	<h5 class="page-header"><span class="glyphicon glyphicon-play" aria-hidden="true"></span> 포인트</h5>
